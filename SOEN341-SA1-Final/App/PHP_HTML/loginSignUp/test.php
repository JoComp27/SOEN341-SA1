...
<ul class="notifications">
    <li class="notification">
        <div class="media">
            ...
            <div class="media-body">
                <strong class="notification-title"><a href="#">Dave Lister</a> commented on <a href="#">DWARF-13 -
                        Maintenance</a></strong>
    ...
    <li class="notification">
        <div class="media">
            ...
            <div class="media-body">
                <strong class="notification-title"><a href="#">Nikola Tesla</a> resolved <a href="#">T-14 - Awesome
                        stuff</a></strong>
    ...
    <li class="notification">
        <div class="media">
            ...
            <div class="media-body">
                <strong class="notification-title"><a href="#">James Bond</a> resolved <a href="#">B-007 - Desolve
