...
INSERT INTO `users` (user_name, user_pass, user_email, user_birthDate, user_gender, user_date)
VALUES ('Administrator', md5('qwerty1'), 'Administrator@Okapi.ca', '01-01-2000', 'M', now())