...
<script src="/SOEN341-SA1/App/PHP_HTML/modifyAnswer/answer_form.js"></script>
...
<div id="modify-answer-<?php echo $a ?>" style="margin: 10px 0;" class="hidden">
    <form id="modify-answer-form-<?php echo $a ?>" action="/SOEN341-SA1/App/PHP_HTML/modifyAnswer/modify_answer_action.php" method="post">
