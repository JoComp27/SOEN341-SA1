...
<div class="container">
    ...
    ?>
    <h8>Username: <strong><?php echo $get_users['user_name']; ?></strong></h8>
    <br>
    <h8>Email: <strong><?php echo $get_users['user_email']; ?></strong></h8>&nbsp;&nbsp;<a style="color:blue;"
                                                                                           onclick="show_CI(1)">Edit</a><br>
    <form id="question-form1" name="question-form1" method="POST" class="hidden">
        <input type="text" name="one">
        <input id="submit" type="submit">
        <br>
    </form>
    <h8>Password: <strong>You logged in, you know it </strong></h8>&nbsp;&nbsp;<a style="color:blue;"
                                                                                  onclick="show_CI(2)">Edit</a><br>
    ...
    <h8>Security Answer of Mother's Maiden Name: <strong><?php echo $get_users['user_answer1']; ?></strong></h8>&nbsp;&nbsp;<a
            style="color:blue;" onclick="show_CI(3)">Edit</a><br>
    ...
    <h8>Security Answer of Childhood Bestfriend: <strong><?php echo $get_users['user_answer2']; ?></strong></h8>&nbsp;&nbsp;<a
            style="color:blue;" onclick="show_CI(4)">Edit</a><br>
    <form id="question-form4" method="POST" name="question-form4" class="hidden">
        <input type="text" name="four">
        <input id="submit" type="submit">
        <br>
    </form>
    <h8>Security Answer of Favourite Restaurant: <strong><?php echo $get_users['user_answer3']; ?></strong></h8>&nbsp;&nbsp;<a
            style="color:blue;" onclick="show_CI(5)">Edit</a><br>
